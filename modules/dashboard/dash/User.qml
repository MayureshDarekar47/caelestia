...
Row {
    ...
    // ===== USER PHOTO/TEXT CONTROL - values come from Dash.qml =====
    property int profilePhotoSize: 155
    property int profileInfoWidth: 260
    property int profileGap: 28

    padding: Tokens.padding.large
    spacing: root.profileGap

    StyledClippingRect {
        // Profile photo size - change 145 to bigger/smaller
        implicitWidth: root.profilePhotoSize
        implicitHeight: root.profilePhotoSize
